[![CI Status](https://api.travis-ci.org/kaltura/playkit-android-youboraplugin.svg?branch=develop)](https://travis-ci.org/github/kaltura/playkit-android-youboraplugin)
